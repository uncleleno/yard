...
class VehicleExteriorPage extends StatefulWidget {
  const VehicleExteriorPage({Key? key}) : super(key: key);

  @override
  State<VehicleExteriorPage> createState() => _VehicleQRScanPageState();
}

class _VehicleQRScanPageState extends State<VehicleExteriorPage> {
                ...
                children: [
                  const Center(
                    child: Padding(
                      ...
                      child: Text("Get ready to take exterior photos photos of the new vehicle you're adding to your yard", textAlign: TextAlign.center,
                        style: TextStyle(
