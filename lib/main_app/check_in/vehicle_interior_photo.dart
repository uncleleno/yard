...
class VehicleInteriorPhotoPage extends StatefulWidget {
  const VehicleInteriorPhotoPage({Key? key}) : super(key: key);

  @override
  State<VehicleInteriorPhotoPage> createState() => _VehicleQRScanPageState();
}

class _VehicleQRScanPageState extends State<VehicleInteriorPhotoPage> {
            ...
            child: ListView(
                children: [
                  ...
                  SizedBox(
                    ...
                    OutlinedButton(
                      onPressed: () {
                        Navigator.pushNamed(context, '/VehicleRadioPage');
                      },
                      style: ButtonStyle(
