...
class VehicleQRScanPage extends StatefulWidget {
  const VehicleQRScanPage({Key? key}) : super(key: key);

  @override
  State<VehicleQRScanPage> createState() => _VehicleQRScanPageState();
}

class _VehicleQRScanPageState extends State<VehicleQRScanPage> {
