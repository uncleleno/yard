...
class SPScanLicensePage extends StatefulWidget {
  const SPScanLicensePage({Key? key}) : super(key: key);

  @override
  State<SPScanLicensePage> createState() => _VehicleQRScanPageState();
}

class _VehicleQRScanPageState extends State<SPScanLicensePage> {
  ...
  void checkData() async {
    storage = Hive.box('vehicleQrScan');
  ...
  Future<void> _scan() async {
    ...
    Navigator.of(context)
        .pushNamed('/SPDriversLicensePage');
  }
