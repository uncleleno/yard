...
class VehicleInteriorAdditionalPhotoPage extends StatefulWidget {
  const VehicleInteriorAdditionalPhotoPage({Key? key}) : super(key: key);

  @override
  State<VehicleInteriorAdditionalPhotoPage> createState() => _VehicleQRScanPageState();
}

class _VehicleQRScanPageState extends State<VehicleInteriorAdditionalPhotoPage> {
            ...
            borderRadius: BorderRadius.circular(20),
              ...
              const ListTile(
                ...
                subtitle: Padding(
                  ...
                  child: Text("Additional Interior Photos Of The New Vehicle", style: TextStyle(color:buttonColorText, fontFamily: "Raleway", fontWeight: FontWeight.bold ),
                  ),
                ),
              ),
                ...
                children: [
                  const Center(
                    child: Padding(
                      ...
                      child: Text("Would you like to take more or less additional photos of the vehicle?", textAlign: TextAlign.center,
                        style: TextStyle(
                        ...
                        children: <Widget>[
                          SizedBox(
                            ...
                            OutlinedButton(
                              ...
                              onPressed: () {
                                {
                                  Navigator.pushNamed(context, '/VehicleChecklistPage');
                                }
                              },
                            ),
                          ),
