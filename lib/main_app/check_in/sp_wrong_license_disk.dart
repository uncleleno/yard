...
class SPWrongLicenseDiskPage extends StatefulWidget {
  const SPWrongLicenseDiskPage({Key? key}) : super(key: key);

  @override
  State<SPWrongLicenseDiskPage> createState() => _VehicleQRScanPageState();
}

class _VehicleQRScanPageState extends State<SPWrongLicenseDiskPage> {
            ...
            borderRadius: BorderRadius.circular(20),
              ...
              const ListTile(
                ...
                subtitle: Padding(
                  ...
                  child: Text("SP's Vehicle With Wrong License Disk", style: TextStyle(color:buttonColorText, fontFamily: "Raleway", fontWeight: FontWeight.bold ),
                  ),
                ),
              ),
                      ...
                      child: Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: const Text("Enter the license plate number of the service provider vehicle:",
