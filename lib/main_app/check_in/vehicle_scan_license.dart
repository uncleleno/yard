...
class VehicleScanLicensePage extends StatefulWidget {
  const VehicleScanLicensePage({Key? key}) : super(key: key);

  @override
  State<VehicleScanLicensePage> createState() => _VehicleQRScanPageState();
}

class _VehicleQRScanPageState extends State<VehicleScanLicensePage> {
  ...
  Future<void> _scan() async {
    ...
    Navigator.of(context).pushNamed('/VehicleDescriptionPage');
  }
