...
class WrongLicenseDiskPage extends StatefulWidget {
  const WrongLicenseDiskPage({Key? key}) : super(key: key);

  @override
  State<WrongLicenseDiskPage> createState() => _VehicleQRScanPageState();
}

class _VehicleQRScanPageState extends State<WrongLicenseDiskPage> {
