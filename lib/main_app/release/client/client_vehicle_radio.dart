...
class ClientVehicleRadioPage extends StatefulWidget {
  const ClientVehicleRadioPage({Key? key}) : super(key: key);

  @override
  State<ClientVehicleRadioPage> createState() => _VehicleQRScanPageState();
}

class _VehicleQRScanPageState extends State<ClientVehicleRadioPage> {
                            ...
                            AbsorbPointer(
                              ...
                              OutlinedButton(
                                ...
                                onPressed: () async {
                                  ...
                                  Navigator.pushNamed(context, '/ClientVehicleInteriorAdditionalPhotoPage');
                                },
                                style: ButtonStyle(
                                    side: MaterialStateProperty.all(
