...
class ClientVehicleInteriorAdditionalPhotoPage extends StatefulWidget {
  const ClientVehicleInteriorAdditionalPhotoPage({Key? key}) : super(key: key);

  @override
  State<ClientVehicleInteriorAdditionalPhotoPage> createState() => _VehicleQRScanPageState();
}

class _VehicleQRScanPageState extends State<ClientVehicleInteriorAdditionalPhotoPage> {
            ...
            borderRadius: BorderRadius.circular(20),
              ...
              const ListTile(
                ...
                subtitle: Padding(
                  ...
                  child: Text("Additional Interior Photos Of The Vehicle", style: TextStyle(color:buttonColorText, fontFamily: "Raleway", fontWeight: FontWeight.bold ),
                  ),
                ),
              ),
                ...
                children: [
                  const Center(
                    child: Padding(
                      ...
                      child: Text("Would you like to take additional photos of the vehicle?", textAlign: TextAlign.center,
                        style: TextStyle(
                  ...
                  const Center(
                    child: Padding(
                      ...
                      child: Text( "First Extra Interior Photo",
                        style: TextStyle(
                            fontSize: 15, fontFamily: "Raleway", fontWeight: FontWeight.bold),
                      ),
                    ),
                  ...
                  const Center(
                    child: Padding(
                      padding: EdgeInsets.only(top: 28.0, bottom: 18.0),
                      child: Text("Second Extra Interior Photo",
                        style: TextStyle(
                            fontSize: 15, fontFamily: "Raleway", fontWeight: FontWeight.bold),
                      ),
                    ),
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(
                            ...
                            OutlinedButton(
                              ...
                              onPressed: () {
                                {
                                  Navigator.pushNamed(context, '/ClientVehicleChecklistPage');
                                }
                              },
                            ),
                          ),
