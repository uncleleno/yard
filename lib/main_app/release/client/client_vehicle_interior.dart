...
class ClientVehicleInteriorPage extends StatefulWidget {
  const ClientVehicleInteriorPage({Key? key}) : super(key: key);

  @override
  State<ClientVehicleInteriorPage> createState() => _VehicleQRScanPageState();
}

class _VehicleQRScanPageState extends State<ClientVehicleInteriorPage> {
  @override
        ...
        Center(
            child: ListView(
                children: [
                  const Center(
                    child: Padding(
                      padding: EdgeInsets.only(top: 28.0, bottom: 18.0, left: 35, right: 35),
                      child: Text("Take interior photos of the new vehicle you're releasing from your yard", textAlign: TextAlign.center,
                        style: TextStyle(
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton(
                      onPressed: () {
                        Navigator.pushNamed(context, '/ClientVehicleInteriorPhotoPage');
                      },
                      style: ButtonStyle(
