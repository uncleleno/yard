...
class ClientVehicleScanLicensePage extends StatefulWidget {
  const ClientVehicleScanLicensePage({Key? key}) : super(key: key);

  @override
  State<ClientVehicleScanLicensePage> createState() => _ClientVehicleScanLicensePageState();
}

class _ClientVehicleScanLicensePageState extends State<ClientVehicleScanLicensePage> {
  ...
  void checkData() async {
    storage = Hive.box('clientVehicleLicenseScan');
  ...
  Future<void> _scan() async {
    ...
    Navigator.of(context).pushNamed('/ClientVehicleDescriptionPage');
  }
